            ...
            >
                <div className="p-12 bg-white rounded-[40px] shadow-[0_32px_80px_rgba(0,0,0,0.5)] relative overflow-hidden group border border-white/10">
                    ...
                    <div className="mb-12 text-center">
                        <h2 className="text-5xl font-light tracking-tighter mb-4 text-slate-900 italic font-serif">Create Account</h2>
                        <p className="text-slate-500 text-lg font-light">Join the future of visa verification</p>
                    </div>
                    ...
                    <form onSubmit={handleSignup} className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-xs uppercase tracking-[0.3em] text-slate-400 font-mono ml-1">Identity</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-xs uppercase tracking-[0.3em] text-slate-400 font-mono ml-1">Security Key</label>
                            <div className="relative group">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs uppercase tracking-[0.3em] text-slate-400 font-mono ml-1">System Privilege</label>
                            <div className="relative group">
                                <Shield className="absolute left-5 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-300 group-focus-within:text-blue-500 transition-colors" />
                                <select
                                    className="w-full h-14 pl-14 pr-6 bg-slate-50 border border-slate-100 rounded-2xl focus:border-blue-500/50 focus:bg-white outline-none transition-all appearance-none text-slate-900 text-lg font-light"
                                    value={role}
                        ...
                        >
                            {isLoading ? <Loader2 className="h-5 w-5 animate-spin" /> : "Initiate Onboarding"}
                        </button>
                    </form>
